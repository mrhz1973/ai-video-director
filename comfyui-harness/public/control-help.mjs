...
export const CONTROL_HELP = Object.freeze({
  ...
  modelSelect: "Seleziona il checkpoint UNET compatibile con il workflow corrente. I modelli non installati in ComfyUI risultano disabilitati.",
...
export function applyStaticControlHelp(documentRef = typeof document !== "undefined" ? document : null) {
  ...
  const map = {
    ...
    model: CONTROL_HELP.modelSelect,
