...
SUMMARY: PR #93 merged. Realignment required YES (docs/bookkeeping only). Accepted application behavior unchanged vs e8f169177ecb8e1be55a4c56092296ab3057d99c. Deployed main SHA 79c73c0e6f8c2a491a2903b850ff5f6142a7aa16. Release v0.19.2. UI v0.19.2. /api/health 0.19.2. /api/config 0.19.2. Tests PASS. Validator PASS. CI PASS. Wave 2 smoke PASS. Director restart YES. ComfyUI restart NO. ComfyUI same PID YES (34240). Queue preflight 0/0. Final queue 0/0. Generation 0. Upload 0. POST /prompt 0. POST /api/queue 0. Queue mutation NO. GPU mutation NO. Project persistent mutation NO.
